...
(function () {
    ...
    function loginUserInternal(tenantId, callback) {
        ...
        xhr.open('POST', abp.appPath + 'api/TokenAuth/Authenticate', true);
    ...
    abp.swagger.login = function (callback) {
        ...
        if (tenancyName) {
            ...
            xhrTenancyName.open('POST', abp.appPath + 'api/services/app/Account/IsTenantAvailable', true);
    ...
    abp.swagger.logout = function (callback) {
        ...
        xhrLogout.open('GET', abp.appPath + 'api/TokenAuth/LogOut', true);

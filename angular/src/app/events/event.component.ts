...
import { EventServiceProxy, EventListDto, EventListDtoListResultDto } from '@shared/service-proxies/service-proxies';
...
export class EventsComponent extends PagedListingComponentBase<EventListDto> {
    ...
    private showCreateOrEditEventDialog(): void {
        let createOrEditEventDialog: BsModalRef;
            createOrEditEventDialog = this._modalService.show(

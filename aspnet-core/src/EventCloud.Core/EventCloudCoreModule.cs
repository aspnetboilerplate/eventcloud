...
namespace EventCloud
{
    ...
    public class EventCloudCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            Configuration.Settings.SettingEncryptionConfiguration.DefaultPassPhrase = EventCloudConsts.DefaultPassPhrase;
            SimpleStringCipher.DefaultPassPhrase = EventCloudConsts.DefaultPassPhrase;
        }

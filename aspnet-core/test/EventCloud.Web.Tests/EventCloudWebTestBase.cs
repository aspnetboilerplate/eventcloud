...
{
    public abstract class EventCloudWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EventCloudWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EventCloudWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EventCloudDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EventCloudDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EventCloudDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EventCloudDbContext, Task<T>> func)
        {
            T result;
